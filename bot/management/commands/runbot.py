...
from goals.models.models import Goal, GoalCategory, BoardParticipant
from bot.models import TgUser
from bot.tg import TgClient
from bot.tg._dc import GetUpdatesResponse, Message
...
class Command(BaseCommand):
	...
	def handle_user(self, msg: Message):
		...
		if not tg_user:
			self.tg_client.send_message(chat_id=msg.chat.id, text="Здравствуй")
		else:
